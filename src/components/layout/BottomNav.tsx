...
import { IconAjustes, IconInicio, IconMovimientos, IconObjetivos, IconPatrimonio, IconVisualizaciones } from './NavIcons';
...
const links = [
  ...
  { to: '/patrimonio', label: 'Patrimonio', Icon: IconPatrimonio },
